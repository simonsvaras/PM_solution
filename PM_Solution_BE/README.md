...
- `GET /api/interns/monthly-hours?from={yyyy-MM-dd}&to={yyyy-MM-dd}` – month-bucketed aggregation of intern hours and costs for the inclusive interval (used by the overview filter).
