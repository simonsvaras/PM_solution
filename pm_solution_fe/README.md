...
- **Projekty / Správa projektů** – create, edit, delete projects and open the repository assignment modal. Modál „Vytvořit projekt“ obsahuje volitelný výběr namespace založený na unikátních hodnotách z GitLab repozitářů. Modál „Správa týmu“ při přiřazení stážistů k projektu obsahuje zaškrtávací pole „Započítat výdaje do vykázaných nákladů projektu“, které ovlivňuje součet nákladů na detailu projektu.
